      ...
      <section className="bg-brand-white py-20 md:py-32">
        <div className="container mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 md:grid-cols-2 lg:px-8">
          ...
          <div className="text-left">
            <h2 className="font-serif text-4xl font-bold tracking-wider text-brand-yellow-dark">
              Uma jornada de Arte e Espiritualidade
            </h2>
            <div className="mt-6 space-y-5 text-lg text-brand-text-muted">
              <p>
                <strong>Marî Brañdz`</strong> é Artista Visual, Astróloga, Taróloga e Reikiana.
              </p>
              <p>
              ...
              <p>
                Fundadora do <Link href="/atendimentos" className="font-bold text-brand-text-muted hover:text-brand-yellow-dark">@omundomare</Link> 🌞, seu propósito é guiar pessoas em suas jornadas de autoconhecimento, expansão da consciência e cura.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-5xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-8 text-center text-gray-200 md:grid-cols-4">
            <div className="flex flex-col items-center">
              <FaMoon className="h-16 w-16 text-brand-yellow" />
              <h3 className="mt-4 font-serif text-2xl font-bold text-brand-white">Astrologia</h3>
              <p className="mt-2 text-brand-bg">Leitura de Mapas</p>
            </div>
            <div className="flex flex-col items-center">
              <FaLayerGroup className="h-16 w-16 text-brand-yellow" />
              <h3 className="mt-4 font-serif text-2xl font-bold text-brand-white">Tarot</h3>
              <p className="mt-2 text-brand-bg">Orientação e Clareza</p>
            </div>
            <div className="flex flex-col items-center">
              <FaHandHoldingHeart className="h-16 w-16 text-brand-yellow" />
              <h3 className="mt-4 font-serif text-2xl font-bold text-brand-white">Reiki</h3>
              <p className="mt-2 text-brand-bg">Cura Energética</p>
            </div>
            <div className="flex flex-col items-center">
              <FaPaintBrush className="h-16 w-16 text-brand-yellow" />
              <h3 className="mt-4 font-serif text-2xl font-bold text-brand-white">Arte</h3>
